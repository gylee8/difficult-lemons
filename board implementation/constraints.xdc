...
set_property PACKAGE_PIN U1 [get_ports {startState[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {startState[0]}]
set_property PACKAGE_PIN T1 [get_ports {startState[1]}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {startState[1]}]
set_property PACKAGE_PIN R2 [get_ports {startState[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {startState[2]}]
...
set_property PACKAGE_PIN W19 [get_ports ctrIn]						
	set_property IOSTANDARD LVCMOS33 [get_ports ctrIn]
